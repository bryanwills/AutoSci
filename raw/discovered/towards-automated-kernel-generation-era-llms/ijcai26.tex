...
\title{Towards Automated Kernel Generation in the Era of LLMs}
...
Peiyu Zang$^{1,2}$
\and
Chi Hsu Tsai$^{1,3}$\and
Haiming Wu$^{1,4}$\and
Yixin Shen$^{1,5}$\and \\
Jialing Zhang$^{1,6}$\and
Haoyu Wang$^{1,7}$\and 
Zhiyou Xiao$^{1,3}$\and
Jingze Shi$^{8}$\and
Yuyu Luo$^{8}$\and \\
Wentao Zhang$^{3}$\and
Chunlei Men$^{1}$\and
Guang Liu$^{1}$ \footnote{Corresponding author, liuguang@baai.ac.cn.}\And
Yonghua Lin$^1$\\
\affiliations
$^1$Beijing Academy of Artificial Intelligence \quad
$^2$Beijing Normal University \\
$^3$Peking University \quad
$^4$Beijing Institute of Technology \quad
$^5$Cornell University \\
$^6$Beijing Jiaotong University \quad
...
\section{LLM for Kernels Generation}
\label{sec:posttraining}
\input{sections/LLM4Triton}

\section{LLM Agent for Kernels Generation}
\label{sec:agents}
\input{sections/LLMAgent4Triton}

\section{Datasets for LLM-Based Kernel Generation}
\label{sec:datasets}
...
\bibliography{ijcai26_check_author}
