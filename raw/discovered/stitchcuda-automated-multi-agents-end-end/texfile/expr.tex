...
\multirow{-2}{*}{Hardware}                                                       & \multirow{-2}{*}{Method}           & Correctness    & Avg Speedup    & $\rm{Fast}_1$           & Correctness    & Avg Speedup    & $\rm{Fast}_1$ & Correctness                 & Avg Speedup                  & $\rm{Fast}_1$                   \\ \hline
                                                                                 ...
                                                                                 & \multicolumn{1}{l|}{StitchCUDA-K} & 13/20          & 2.11x          & 30\%          & 17/20          & 0.82x          & 65\%          & \underline{7/10} & { 0.42x} & { 0\%} \\
                                                                                 & \multicolumn{1}{l|}{StitchCUDA-G} & \textbf{19/20} & \textbf{3.97x} & \textbf{55\%} & \textbf{19/20} & \textbf{1.87x} & \textbf{95\%} & 6/10                  & {\underline{ 0.99x}}                  & {\underline{ 50\%}}            \\
\multirow{-9}{*}{\begin{tabular}[c]{@{}c@{}}PRO 6000\\ (BlackWell)\end{tabular}} & StitchCUDA                        & {\underline{ 18/20}}    & {\underline{ 2.86x}}    & 35\%          & \textbf{19/20} & {\underline{ 1.55x}}    & {\underline{ 85\%}}    & \textbf{10/10}              & \textbf{1.27x}               & \textbf{70\%}            \\ \hline
