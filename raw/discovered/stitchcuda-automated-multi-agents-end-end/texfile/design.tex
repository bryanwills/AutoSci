 ...
 \begin{figure*}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{pic/main-workflow.pdf}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=0.85\linewidth]{pic/RL.pdf}
...
% We further employ several practical techniques to stabilize reward assignment and policy optimization, which are detailed in Appendix~A.
